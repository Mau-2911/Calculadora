...
public class PilaA <T> implements PilaADT <T>{
    ...
    /* 
     * Agrega el dato en el tope, redefiniendo el valor de éste.
     * Si la pila está llena,se construye un arreglo de mayor capacidad 
     * y se copian los elementos de la pila a éste.
     */
    ...
    /* 
     * Elimina y regresa el elemento que está en el tope de la pila, 
     * redefiniendo el valor del tope. Si la pila está vacía lanza una excepción.
     */
    public T pop() {
        if (isEmpty())
